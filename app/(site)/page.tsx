          ...
          <div className="about-grid">
            <AnimatedSection animation="fade-right" className="about-images">
              <div className="about-img-wrapper">
                <Image
                  src={homepage?.aboutSection?.image1 || "/images/about/pole-dance.jpg"}
              ...
              <div className="about-img-wrapper">
                <Image
                  src={homepage?.aboutSection?.image2 || "/images/about/aerial-hoop.jpg"}
        ...
        <div className="container">
          <AnimatedSection className="voucher-card">
            ...
            <div className="voucher-image">
              <Image
                src={homepage?.voucherSection?.image || "/images/promo/promo-bg.jpg"}
                alt="Voucher Sway"
                width={500}
                height={400}
                quality={80}
