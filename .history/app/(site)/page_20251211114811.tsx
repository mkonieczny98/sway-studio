          ...
          <div className="about-grid">
            <AnimatedSection animation="fade-right" className="about-images">
              <div className="about-img-wrapper">
                <img
                  src="https://swaypoledancestudio.pl/wp-content/uploads/elementor/thumbs/3B0A9050-facebook-pgn10apm3vfpkfxcw8set7eua95vejud6mjyiukck0.jpg"
              ...
              <div className="about-img-wrapper">
                <img
                  src="https://swaypoledancestudio.pl/wp-content/uploads/elementor/thumbs/3B0A9851-1-2-scaled-e1664454155694-pvh5a08pali9sgigpcm3a1ico1rkrxy7goafuy03go.jpg"
        ...
        <div className="container">
          <AnimatedSection className="voucher-card">
            ...
            <div className="voucher-image">
              <img
                src="https://swaypoledancestudio.pl/wp-content/uploads/elementor/thumbs/3B0A0605-scaled-e1664453271188-pvh4mxbdh1wsp61fhdfw1v6vjfj3ribhmfl7mc8494.jpg"
                alt="Voucher Sway"
              />
            </div>
          </AnimatedSection>
