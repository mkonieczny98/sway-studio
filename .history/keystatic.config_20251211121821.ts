      ...
      schema: {
        heroSection: fields.object({
          ...
          colors: fields.object({
            titleColor: fields.text({ label: 'Kolor tytułu', defaultValue: '#ffffff' }),
            highlightColor: fields.text({ label: 'Kolor wyróżnionego słowa', defaultValue: '#7d8c6e' }),
            subtitleColor: fields.text({ label: 'Kolor podtytułu', defaultValue: '#7d8c6e' }),
            descColor: fields.text({ label: 'Kolor opisu', defaultValue: '#e8e2d9' }),
        ...
        aboutSection: fields.object({
          ...
          // Kolory About
          colors: fields.object({
            bgColor: fields.text({ label: 'Kolor tła sekcji', defaultValue: '#fdfbf7' }),
            titleColor: fields.text({ label: 'Kolor tytułu', defaultValue: '#3d3329' }),
            textColor: fields.text({ label: 'Kolor tekstu', defaultValue: '#5c5145' }),
            featureIconColor: fields.text({ label: 'Kolor ikon cech', defaultValue: '#7d8c6e' }),
            featureTextColor: fields.text({ label: 'Kolor tekstu cech', defaultValue: '#3d3329' }),
        ...
        promoSection: fields.object({
          ...
          // Kolory Promo
          colors: fields.object({
            bgColor: fields.text({ label: 'Kolor tła karty', defaultValue: '#f5f0e8' }),
            labelColor: fields.text({ label: 'Kolor etykiety "Oferta specjalna"', defaultValue: '#7d8c6e' }),
            titleColor: fields.text({ label: 'Kolor tytułu', defaultValue: '#3d3329' }),
            priceColor: fields.text({ label: 'Kolor ceny', defaultValue: '#7d8c6e' }),
            textColor: fields.text({ label: 'Kolor opisu', defaultValue: '#5c5145' }),
            buttonBg: fields.text({ label: 'Kolor tła przycisku', defaultValue: '#7d8c6e' }),
            buttonText: fields.text({ label: 'Kolor tekstu przycisku', defaultValue: '#ffffff' }),
        ...
        locationSection: fields.object({
          ...
          colors: fields.object({
            ...
            titleColor: fields.text({ label: 'Kolor tytułu', defaultValue: '#3d3329' }),
            textColor: fields.text({ label: 'Kolor tekstu', defaultValue: '#5c5145' }),
            iconColor: fields.text({ label: 'Kolor ikon', defaultValue: '#7d8c6e' }),
        ...
        ctaSection: fields.object({
          ...
          // Kolory CTA
          colors: fields.object({
            bgColor: fields.text({ label: 'Kolor tła sekcji', defaultValue: '#7d8c6e' }),
            titleColor: fields.text({ label: 'Kolor tytułu', defaultValue: '#ffffff' }),
            textColor: fields.text({ label: 'Kolor tekstu', defaultValue: '#e8e2d9' }),
            buttonBg: fields.text({ label: 'Kolor tła przycisku', defaultValue: '#ffffff' }),
            buttonText: fields.text({ label: 'Kolor tekstu przycisku', defaultValue: '#7d8c6e' }),
          }, { label: '🎨 Kolory sekcji CTA' }),
        }, { label: '🚀 Sekcja CTA (dół strony)' }),

        // ========== KOLORY KART ZAJĘĆ ==========
        classCardsColors: fields.object({
          cardBg: fields.text({ label: 'Kolor tła karty', defaultValue: '#ffffff' }),
          cardBorder: fields.text({ label: 'Kolor obramowania karty', defaultValue: '#e8e2d9' }),
          cardHoverBorder: fields.text({ label: 'Kolor obramowania przy hover', defaultValue: '#7d8c6e' }),
          iconColor: fields.text({ label: 'Kolor ikony', defaultValue: '#7d8c6e' }),
          titleColor: fields.text({ label: 'Kolor tytułu', defaultValue: '#3d3329' }),
          descColor: fields.text({ label: 'Kolor opisu', defaultValue: '#8a7f72' }),
          linkColor: fields.text({ label: 'Kolor linku', defaultValue: '#7d8c6e' }),
        }, { label: '🎨 Kolory kart zajęć (na stronie głównej)' }),

        // ========== KOLORY KARNETÓW ==========
        pricingCardsColors: fields.object({
          cardBg: fields.text({ label: 'Kolor tła karty', defaultValue: '#ffffff' }),
          cardBorder: fields.text({ label: 'Kolor obramowania', defaultValue: '#e8e2d9' }),
          featuredBg: fields.text({ label: 'Kolor tła karty wyróżnionej', defaultValue: '#7d8c6e' }),
          featuredText: fields.text({ label: 'Kolor tekstu karty wyróżnionej', defaultValue: '#ffffff' }),
          badgeColor: fields.text({ label: 'Kolor badge "Popularny"', defaultValue: '#7d8c6e' }),
          titleColor: fields.text({ label: 'Kolor tytułu (ilość wejść)', defaultValue: '#3d3329' }),
          subtitleColor: fields.text({ label: 'Kolor podtytułu (okres)', defaultValue: '#8a7f72' }),
          priceColor: fields.text({ label: 'Kolor ceny', defaultValue: '#7d8c6e' }),
          featuresColor: fields.text({ label: 'Kolor listy cech', defaultValue: '#5c5145' }),
        }, { label: '🎨 Kolory kart cennikowych (karnety)' }),

        // ========== KOLORY OPINII ==========
        testimonialsColors: fields.object({
          cardBg: fields.text({ label: 'Kolor tła karty', defaultValue: '#f5f0e8' }),
          starsColor: fields.text({ label: 'Kolor gwiazdek', defaultValue: '#7d8c6e' }),
          textColor: fields.text({ label: 'Kolor tekstu opinii', defaultValue: '#3d3329' }),
          authorColor: fields.text({ label: 'Kolor imienia autora', defaultValue: '#3d3329' }),
          sourceColor: fields.text({ label: 'Kolor źródła (Google)', defaultValue: '#8a7f72' }),
